...
namespace Ari.Bilgi.HastaKayit
{
    public partial class DoktorEkle : System.Web.UI.Page
    {
        ...
        protected void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            //Gridview Yenile (datayı tekrar çek)
        ...
        public void Ekle()
        {
            ...
            SqlCommand cmd = new SqlCommand("sp_insertDoctor", conn);
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.AddWithValue("@DoktorAdi", txtDoktorAdi.Text.Trim());
            cmd.Parameters.AddWithValue("@Brans", txtBrans.Text.Trim());
