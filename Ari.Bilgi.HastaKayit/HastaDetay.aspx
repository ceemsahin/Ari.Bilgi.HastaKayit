<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HastaDetay.aspx.cs" Inherits="Ari.Bilgi.HastaKayit.HastaDetay" %>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <label>Giriş Tarihi</label> 
                   <asp:TextBox ID="txtGirisTarihi" CssClass="form-control"  runat="server"></asp:TextBox>
            </div>

             <div class="form-group">
                <label>Çıkış Tarihi</label>
                   <asp:TextBox ID="txtCikisTarih" CssClass="form-control"  runat="server"></asp:TextBox>
            </div>
